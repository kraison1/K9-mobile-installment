...
import TableProcessCase from "src/components/tables/tableProcessCase";
import ModalProcessCase from "src/components/modals/modalProcessCase";
import { fetchProcessCase, updateProcessCase } from "src/store/processCase";
import { useDispatch, useSelector } from "react-redux";
import ModalClaimMobileContact from "src/components/modals/modalClaimMobileContact";

const DefaultValues = {};

const ProcessCasePage = () => {
  ...
  const [RowDataClaimMobile, setRowDataClaimMobile] = React.useState({});
...
export default ProcessCasePage;
