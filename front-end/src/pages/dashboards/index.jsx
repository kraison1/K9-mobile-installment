...
import TableBook from "src/components/tables/tableProductBook";
import ModalBook from "src/components/modals/modalProductBook";
import { useDispatch, useSelector } from "react-redux";
import { addProductBook, fetchProductBook } from "src/store/productBook";
    ...
    <div className="grid gap-4 overflow-x-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="col-span-2 md:col-span-1">
          <button
            type="button"
            className="w-full md:w-6/12 px-6 py-2.5 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg transition-colors duration-200 shadow-sm"
            onClick={() => addRow()}
          >
            เพิ่มข้อมูลใหม่
          </button>
        ...
        <div className="col-span-2">
          <div className="grid grid-cols-1 gap-6 bg-white p-6 rounded-xl shadow-md">
            <div className="grid-cols-2 md:col-span-1 justify-items-end">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {SearchType == "1" ? (
                <div className="w-full flex flex-col md:flex-row md:items-end gap-6">
            ...
            {/* Radio Buttons */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid-cols-2 md:col-span-1">
                <label className="block mb-2 text-sm font-medium text-gray-700">
                  สถานะ
                </label>
                <div className="flex flex-row flex-wrap gap-6">
