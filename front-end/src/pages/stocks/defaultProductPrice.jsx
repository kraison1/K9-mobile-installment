...
import TableDefaultProductPrice from "src/components/tables/tableDefaultProductPrice";
import ModalDefaultProductPrice from "src/components/modals/modalDefaultProductPrice";
import { useDispatch, useSelector } from "react-redux";
import {
  addDefaultProductPrice,
  fetchDefaultProductPrice,
  updateDefaultProductPrice,
} from "src/store/defaultProductPrice";
...
const DefaultProductPrice = () => {
  ...
  const store = useSelector((state) => state.defaultProductPrice);
  ...
  const submitRow = (e) => {
    setIsLoadingOpen(true);
    if (isNaN(e.id)) {
      dispatch(addDefaultProductPrice(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
    } else {
      dispatch(updateDefaultProductPrice(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
...
export default DefaultProductPrice;
