...
import TableStockProductType from "src/components/tables/tableStockProductType";
import ModalStockProductType from "src/components/modals/modalStockProductType";
import { useDispatch, useSelector } from "react-redux";
import {
  addProductTypes,
  fetchProductTypes,
  updateProductTypes,
} from "src/store/productType";
...
const ProductTypePage = () => {
  ...
  const submitRow = (e) => {
    setIsLoadingOpen(true);
    if (isNaN(e.id)) {
      dispatch(addProductTypes(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
    } else {
      dispatch(updateProductTypes(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
