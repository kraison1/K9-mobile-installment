...
const ProductSale = ({ data }) => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="สรุปยอด ค่าเปิดใช้เครื่อง/ขายสด"
    >
      <h2
        className="text-2xl font-bold text-gray-800 mb-6 flex items-center"
        aria-label={`สรุปยอด ค่าเปิดใช้เครื่อง/ขายสด ${
          infoProductSale.typeLabel || "(มือถือ)"
        }`}
      >
        สรุปยอด ค่าเปิดใช้เครื่อง/ขายสด{" "}
        {infoProductSale.typeLabel || "(มือถือ)"}
      </h2>
      ...
      <div className="space-y-6">
        {renderSaleSection(notCancelled, "รายการที่ไม่ยกเลิก", false)}
        {renderSaleSection(cancelled, "รายการที่ยกเลิก", true)}
