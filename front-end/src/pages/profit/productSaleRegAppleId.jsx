...
const ProductSaleRegAppleId = ({ data }) => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="สรุปยอด ค่าสมัครอีเมล/AppleID/อื่น ๆ"
    >
      <h2
        className="text-2xl font-bold text-gray-800 mb-6 flex items-center"
        aria-label={`สรุปยอด ${infoProductSale.typeLabel || ""}`}
      >
        สรุปยอด {infoProductSale.typeLabel || ""}
      </h2>
      ...
      <div className="space-y-6">
        {renderSaleSection(notCancelled, "รายการที่ไม่ยกเลิก", false, true)}
        {renderSaleSection(cancelled, "รายการที่ยกเลิก", true, true)}
...
ProductSaleRegAppleId.propTypes = {
...
ProductSaleRegAppleId.defaultProps = {
  data: {
    productSales: [],
    typeLabel: "",
    branchName: "",
...
export default ProductSaleRegAppleId;
