...
const ProductSaleReRider = ({ data }) => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="สรุปยอด รับค่าส่ง"
    >
      <h2
        className="text-2xl font-bold text-gray-800 mb-6 flex items-center"
        aria-label={`สรุปยอด ${
          infoProductSale.typeLabel || ""
        }`}
      >
...
ProductSaleReRider.defaultProps = {
  data: {
    productSales: [],
    typeLabel: "",
    branchName: "",
...
export default ProductSaleReRider;
