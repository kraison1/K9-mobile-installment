...
import TableShopInsurance from "src/components/tables/tableShopInsurance";
import ModalShopInsurance from "src/components/modals/modalShopInsurance";
import {
  addShopInsurance,
  fetchShopInsurance,
  updateShopInsurance,
} from "src/store/shopInsurance";
...
const SettingShopInsurancePage = () => {
  ...
  const store = useSelector((state) => state.shopInsurance);
  ...
  const submitRow = (e) => {
    setIsLoadingOpen(true);
    if (isNaN(e.id)) {
      dispatch(addShopInsurance(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
    } else {
      dispatch(updateShopInsurance(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
...
export default SettingShopInsurancePage;
