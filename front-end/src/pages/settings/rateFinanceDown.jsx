...
import TableRateFinanceDown from "src/components/tables/tableRateFinanceDown";
import ModalRateFinanceDown from "src/components/modals/modalRateFinanceDown";
import { useDispatch, useSelector } from "react-redux";
import {
  addRateFinanceDown,
  fetchRateFinanceDown,
  updateRateFinanceDown,
} from "src/store/rateFinanceDown";
...
const SettingRateFinanceDownPage = () => {
  ...
  const submitRow = (e) => {
    setIsLoadingOpen(true);
    if (isNaN(e.id)) {
      dispatch(addRateFinanceDown(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
    } else {
      dispatch(updateRateFinanceDown(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
...
export default SettingRateFinanceDownPage;
