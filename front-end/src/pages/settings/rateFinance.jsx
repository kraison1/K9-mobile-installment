...
import TableRateFinance from "src/components/tables/tableRateFinance";
import ModalRateFinance from "src/components/modals/modalRateFinance";
import { useDispatch, useSelector } from "react-redux";
import {
  addRateFinance,
  fetchRateFinance,
  updateRateFinance,
} from "src/store/rateFinance";
...
const SettingRateFinancePage = () => {
  ...
  const submitRow = (e) => {
    setIsLoadingOpen(true);
    if (isNaN(e.id)) {
      dispatch(addRateFinance(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
    } else {
      dispatch(updateRateFinance(e))
        .unwrap()
        .then(() => setIsLoadingOpen(false))
        .catch(() => setIsLoadingOpen(false));
      setModal(false);
...
export default SettingRateFinancePage;
