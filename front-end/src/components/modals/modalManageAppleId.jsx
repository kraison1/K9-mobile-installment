...
import { fetchInfoManageAppleId } from "src/store/manageAppleId";
import Select from "react-select";
import { fetchSelectBranch } from "src/store/branch";

const ModalManageAppleId = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoManageAppleId(id))
      .unwrap()
                ...
                render={({ field }) => (
                  <input
                    ...
                    className={`mt-1 block w-full px-3 py-2 border ${
                      errors.appId ? "border-red-500" : "border-gray-300"
...
export default ModalManageAppleId;
