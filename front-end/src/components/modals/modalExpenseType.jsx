...
import { fetchInfoExpenseType } from "src/store/expenseType";
import { useDispatch, useSelector } from "react-redux";
import { useAuth } from "src/hooks/authContext";

const ModalExpenseType = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoExpenseType(id))
      .unwrap()
                ...
                render={({ field }) => (
                  <div>
                    <input
                      ...
                      className="mr-2"
                    />
                    <label htmlFor="type-2" className="text-red-500">
                      ไม่คิดต้นทุน
                    </label>
                    <input
                      {...field}
                      ...
                      className="mr-2 ml-4"
                    />
                    <label htmlFor="type-2" className="text-green-500">
                      คิดต้นทุน
                    </label>
                  </div>
                )}
