...
import { fetchInfoRatePurchase } from "src/store/ratePurchase";
...
const ModalRatePurchase = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoRatePurchase(id))
      .unwrap()
...
export default ModalRatePurchase;
