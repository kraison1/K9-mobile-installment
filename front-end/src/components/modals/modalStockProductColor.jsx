...
import { fetchInfoProductColors } from "src/store/productColor";

const ModalStockProductColor = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoProductColors(id))
      .unwrap()
...
ModalStockProductColor.propTypes = {
  open: PropTypes.bool,
...
export default ModalStockProductColor;
