...
const ModalSale = ({ open, setModal, RowData, submitRow }) => {
  ...
  React.useEffect(() => {
    const selectedProvinceId = watchCustomer("idCardProvinceId");
    if (selectedProvinceId) {
      dispatch(fetchSelectIdCardDistrict(selectedProvinceId));
    }
  }, [watchCustomer("idCardProvinceId")]);
  ...
  React.useEffect(() => {
    const selectedProvinceId = watchCustomer("idCardDistrictId");
    if (selectedProvinceId) {
      dispatch(fetchSelectIdCardSubdistrict(selectedProvinceId));
    }
  }, [watchCustomer("idCardDistrictId")]);
    ...
    if (!isEmpty(storeRateFinance.select)) {
      setRateFinances(
        storeRateFinance.select.map((item) => ({
          ...
          label: item.name,
          valueMonth: item.valueMonth,
          maximumRental: item.maximumRental,
        ...
        if (isNumber(RowData.productBookId)) {
          ...
          dispatch(
            fetchSelectReseller({
              branchId: user.branchId,
              customerType: ["1", "3", "4"],
              search: RowData.id == undefined ? "" : RowData.resellerId,
            }),
          );
  ...
  const onSubmit = async (data) => {
    ...
    const isTrigger = await triggerCustomer();
    if (isTrigger) {
    ...
    >
      <form
        ...
        className={`relative w-full ${
          watch("isMobileSale") == "1" ? "w-full" : "max-w-4xl"
        }`}
        ref={container}
      >
        <div className="bg-white rounded-lg shadow overflow-y-auto max-h-[95vh]">
          ...
          <div className="p-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              {permissions.includes("edit-contract") && watch("id") ? (
                <div className="items-center col-span-4">
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    {["3", "4"].includes(watch("saleType")) && watch("id") ? (
                    ...
                    ["3", "4"].includes(watch("saleType")) ? (
                      <div className="items-center col-span-4 md:col-span-3">
                        <label
                          htmlFor="randomCode"
                        ...
                        <Controller
                          name="randomCode"
                          control={control}
                          rules={{ required: watch("id") ? true : false }}
                          render={({ field }) => (
                    ...
                    {watch("isMobileSale") == "1" &&
                    ["3", "4"].includes(watch("saleType")) ? (
                      <div className="items-center col-span-4 md:col-span-1">
                    ...
                    {watch("isMobileSale") == "1" &&
                    ["3", "4"].includes(watch("saleType")) ? (
                      <div className="items-center col-span-4 md:col-span-2">
                        <label
                          htmlFor="create_date"
                    ...
                    watch("id") &&
                    ["3", "4"].includes(watch("saleType")) ? (
                      <div className="grid justify-items-start md:justify-items-end col-span-4 md:col-span-2">
                        <label
                          htmlFor="caseDate"
                          className="block text-sm font-medium text-gray-700"
                        >
              ...
              {watch("id") && permissions.includes("edit-appleId") ? (
                <div className="items-center col-span-4">
              ...
              <fieldset
                ...
                className="items-center col-span-4 grid grid-cols-1 gap-4"
              >
                {
                  <div className="items-center col-span-4">
                    <label
                    ...
                    <Controller
                      ...
                      rules={{ required: true }}
                      render={(
                        { field }, //md:flex-row md:items-center gap-4 md:gap-6
                      ) => (
                ...
                <div className="items-center col-span-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="items-center col-span-4 md:col-span-4">
                      <label
                        htmlFor="customerId"
                        className="block text-sm font-medium text-gray-700 mr-2"
                      >
                    ...
                    <div className="items-center col-span-4">
                      ...
                      >
                        ...
                        <div className="items-center md:col-span-2">
                            ...
                            <div className="items-center">
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="items-center">
                                  ...
                                  {errorsCustomer.idCardProvinceId && (
                                    <span className="text-red-500 text-xs mt-1">
                                      กรุณาใส่ข้อมูล จังหวัด
                                    </span>
                                  )}
                                ...
                                <div className="items-center">
                                  ...
                                  {errorsCustomer.idCardDistrictId && (
                                    <span className="text-red-500 text-xs mt-1">
                                      กรุณาใส่ข้อมูล อำเภอ
                                    </span>
                                  )}
                                ...
                                <div className="items-center">
                                  ...
                                  {errorsCustomer.idCardSubdistrictId && (
                                    <span className="text-red-500 text-xs mt-1">
                                      กรุณาใส่ข้อมูล ตำบล
                                    </span>
                                  )}
                        ...
                        <div className="items-center md:col-span-2">
                          <label
                            ...
                            className="block text-sm font-medium text-gray-700 mr-2"
                          >
                            อัพโหลดบัตรประชาชนลูกค้า png, jpeg, jpg
                          </label>
                          <FileDropzone
                            isOpen={open}
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <div className="items-center col-span-4">
                  <div className="grid grid-cols-1 gap-4">
                    <div className="items-center col-span-4"></div>
                    <div className="items-center col-span-4">
                      <label
                        htmlFor="productId"
                    ...
                    {watch("productId") ? (
                      <fieldset disabled className="items-center col-span-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="items-center col-span-3 md:col-span-1">
                            <label
                          ...
                          <div className="items-center col-span-3 md:col-span-1 border p-1 border-gray-300 rounded-md">
                            <label
                              htmlFor="hand"
                              className="block text-sm font-medium text-gray-700 mr-2"
                            >
                          ...
                          <div className="items-center col-span-3 md:col-span-2 border p-1 border-gray-300 rounded-md">
                            <label
                              htmlFor="boxType"
                              className="block text-sm font-medium text-gray-700 mr-2"
                            >
                        ...
                        <label htmlFor="boxType-2" className="text-green-400">
                          ...
                          <div className="items-center col-span-3 md:col-span-3 border p-1 border-gray-300 rounded-md">
                            <label
                              htmlFor="freeGift"
                              className="block text-sm font-medium text-gray-700 mr-2"
                            >
                          ...
                          <div className="items-center col-span-3 md:col-span-3">
                            <HorizontalRule />
                          </div>
                        </div>
                      </fieldset>
                                ...
                                onChange={(selectedOption) => {
                                  if (!isEmpty(selectedOption)) {
                                    if (
                                      ...
                                      selectedOption.maximumRental == "1"
                                    ) {
                                      field.onChange("");
                                      error(
                                        `มือ 2 ให้ผ่อนสูงสุดที่ ${selectedOption.valueMonth} เดือน`,
                                      );
                                    } else {
                                      setValue(
                                        "valueMonth",
              ...
              <div className="items-center col-span-4 lg:col-span-2"></div>

              <div className="items-center col-span-4 lg:col-span-2">
                <label // This seems to be part of the right column now.
              ...
              <div className="items-center col-span-4 grid grid-cols-1 lg:grid-cols-4 gap-4">
                <div className="items-center col-span-4">
                  <label
                    htmlFor="note"
                    className="block text-sm font-medium text-gray-700 mr-2"
                      ...
                      render={({ field }) => (
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            const priceTotalPaid = Number(
                              watch("priceTotalPaid"),
                            );
                            setValue(
                              "priceTransferCash",
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          ...
                          type="number"
                          onChange={(e) => {
                            const priceReRiderTransferCash = Number(
                              e.target.value,
                            );
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          ...
                          type="number"
                          onChange={(e) => {
                            const priceEquipTransferCash = Number(
                              e.target.value,
                            );
                ...
                <div className="items-center col-span-4">
                  <label
                    ...
                    className="block text-sm font-medium text-gray-700 mr-2"
                  >
                    อัพโหลดไฟล์หลักฐานการจ่ายเงิน png, jpeg, jpg
                  </label>
                  <FileDropzone
                    isOpen={open}
