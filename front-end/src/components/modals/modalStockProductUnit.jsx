...
import { fetchInfoProductUnits } from "src/store/productUnit";

const ModalStockProductUnit = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoProductUnits(id))
      .unwrap()
...
ModalStockProductUnit.propTypes = {
  open: PropTypes.bool,
...
export default ModalStockProductUnit;
