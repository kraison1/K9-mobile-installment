...
import { fetchInfoProductStorages } from "src/store/productStorage";

const ModalStockProductStorage = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoProductStorages(id))
      .unwrap()
...
ModalStockProductStorage.propTypes = {
  open: PropTypes.bool,
...
export default ModalStockProductStorage;
