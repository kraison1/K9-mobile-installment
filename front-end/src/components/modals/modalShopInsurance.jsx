...
import { fetchInfoShopInsurance } from "src/store/shopInsurance";
import { useDispatch, useSelector } from "react-redux";
import { useAuth } from "src/hooks/authContext";

const ModalShopInsurance = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoShopInsurance(id))
      .unwrap()
...
export default ModalShopInsurance;
