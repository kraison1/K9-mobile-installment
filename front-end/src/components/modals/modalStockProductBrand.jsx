...
import { fetchInfoProductBrands } from "src/store/productBrand";
...
const ModalStockProductBrand = ({ open, setModal, RowData, submitRow }) => {
  ...
  const fetchInfo = (id) => {
    ...
    dispatch(fetchInfoProductBrands(id))
      .unwrap()
      ...
      >
        <div className="bg-white rounded-lg shadow overflow-y-auto max-h-[95vh]">
          ...
          <div className="p-2 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="items-center col-span-2 lg:col-span-2">
              <label
                htmlFor="uploadFileProductBrand"
                className="block text-sm font-medium text-gray-700 mr-2"
              >
            ...
            {!isEmpty(watch("fileProductBrand")) ? (
              <div className="items-center col-span-2 lg:col-span-2 ">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  <div className="col-span-1 lg:col-span-2 flex justify-center">
                    {noImage(watch("fileProductBrand"))}
                  </div>
                </div>
              </div>
            ) : null}
                ...
                render={({ field }) => (
                  <div>
                    <input
                      ...
                      className="mr-2"
                    />
                    <label htmlFor="showStock-1" className="text-green-400">
                      แสดงในคลัง
                    </label>
                    ...
                    <input
                      ...
                      className="mr-2 ml-4"
                    />
                    <label htmlFor="showStock-0" className="text-red-400">
                      ไม่แสดงในคลัง
                    </label>
                  </div>
                )}
...
ModalStockProductBrand.propTypes = {
  open: PropTypes.bool,
...
export default ModalStockProductBrand;
