...
const TableBranch = ({ tableHeaders, tableLists, onClick, page, pageSize }) => {
  return (
        ...
        <tbody>
          {tableLists.map((TableList, k) => (
            <tr className="bg-white" key={k}>
              ...
              <td className="border p-2 font-light">{TableList.online_str}</td>
            </tr>
          ))}
        </tbody>
      </table>
