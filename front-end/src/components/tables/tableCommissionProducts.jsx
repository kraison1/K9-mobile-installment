...
const TableModalCommissionProducts = ({
  tableHeaders,
  tableLists,
  onClick,
  page,
        ...
        <tbody>
          {tableLists.map((TableList, k) => (
            <tr className="bg-white" key={k}>
              ...
              <td className="border p-2 font-light">
                {TableList.productModel?.catalog == "มือถือ"
                  ? tableLists.hand
                  : "-"}
              </td>
              <td className="border p-2 font-light text-right">
                {formatNumberDigit(TableList.priceCommission)}
              </td>
              <td className="border p-2 font-light">
...
TableModalCommissionProducts.propTypes = {
...
export default TableModalCommissionProducts;
