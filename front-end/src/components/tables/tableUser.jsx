...
const TableUser = ({ tableHeaders, tableLists, onClick, page, pageSize }) => {
  return (
        ...
        <tbody>
          {tableLists.map((TableList, k) => (
            <tr className="bg-white" key={k}>
              ...
              <td className="border p-2 font-light">{`${TableList.name} ${TableList.lastname}`}</td>
              <td className="border p-2 font-light">{TableList.tel}</td>
              <td className="border p-2 font-light">{`${
                isEmpty(TableList.userGroup) ? "" : TableList.userGroup.name
              }`}</td>
              ...
              <td className="border p-2 font-light">{`${TableList.type}`}</td>
            </tr>
          ))}
        </tbody>
      </table>
