...
const TableRateFinance = ({ tableHeaders, tableLists, onClick, page, pageSize }) => {
  return (
        ...
        <tbody>
          {tableLists.map((TableList, k) => (
            <tr className="bg-white" key={k}>
              ...
              <td className="border p-2 font-light text-right">{TableList.percentCommission}</td>
              <td className="border p-2 font-light text-right">{TableList.valueMonth}</td>
              <td className="border p-2 font-light text-right">
                {TableList.valueEqual}
              </td>
            </tr>
          ))}
        </tbody>
...
export default TableRateFinance;
