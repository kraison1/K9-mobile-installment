...
const TableStockProductBrand = ({
  ...
  return (
    <div className="overflow-x-auto">
      <table className="rounded-sm text-left border border-collapse border-1 table-fixed w-full truncate">
            ...
            <tr className="bg-white" key={k}>
              ...
              <td className="border p-2 font-light">
                <div className="flex justify-center items-center">
                  {noImage(TableList.fileProductBrand)}
                </div>
              </td>
              <td
              ...
              <td className="border p-2 font-light">{TableList.name}</td>
              <td className="border p-2 font-light">
                {Array.isArray(TableList.catalog)
                  ? TableList.catalog.join(",")
                  : TableList.catalog}
              </td>
            </tr>
          ))}
...
TableStockProductBrand.propTypes = {
...
export default TableStockProductBrand;
