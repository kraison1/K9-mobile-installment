...
IMAGE_NAME="thunder-bolt-service"
TAG="latest"
CONTAINER_NAME="thunder-bolt-service"
PORT="4001"

# Volume mappings be only
VOLUME_MAPPING="/home/user/uploads:/app/uploads"
...
docker run -d --name $CONTAINER_NAME --network thunder-bolt-network --restart unless-stopped -v $VOLUME_MAPPING -p ${PORT}:${PORT} ${IMAGE_NAME}:${TAG}
